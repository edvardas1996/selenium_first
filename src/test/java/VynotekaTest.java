...
public class VynotekaTest {
    ...
    public void adPositiveTest() {
      //  driver.findElement(By.id("omnisend-forms-container")).findElement(By.tagName("button"));
        driver.get("https://vynoteka.lt/");//*[@id="omnisend-forms-container"]/div/div[2]/div[2]/div[2]/button
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("omnisend-forms-container")));
        driver.findElement(By.id("omnisend-forms-container")).findElement(By.tagName("button")).click();
...
//        driver.findElement(By.xpath("//*[@id=\"omnisend-form-63ff1f31b40d6530aba59a6d-form-close-icon\"]/path")).click();
